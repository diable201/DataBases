...
SELECT name, code, budget FROM departments WHERE budget > 60000  ORDER BY budget ASC, code DESC;
-- 16. Reduce the budget of department with lowest budget by 10%.
UPDATE departments SET budget = 0.9 * budget WHERE budget = (
...
DELETE FROM employees RESTRICT;